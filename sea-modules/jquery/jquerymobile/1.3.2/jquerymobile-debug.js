...
;(function ( root, doc, factory ) {
	if ( typeof define === "function" && define.cmd ) {
		...
		define('sea-modules/jquery/jquerymobile/1.3.2/jquerymobile-debug',[ "sea-modules/jquery/jquery/2.0.3/jquery-debug"],function ( require, exports, module) {
			var $ = require('sea-modules/jquery/jquery/2.0.3/jquery-debug');
			factory( $, root, doc );
			return $;
		});
	} else {
